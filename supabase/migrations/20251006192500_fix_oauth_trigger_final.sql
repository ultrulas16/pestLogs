/*
  # Fix OAuth Trigger - Final Version

  1. Changes
    - Drop and recreate OAuth trigger with proper field handling
    - Ensure all required fields are included
    - Add comprehensive error handling and logging
    - Support Google OAuth user registration

  2. Security
    - Function runs with SECURITY DEFINER privileges
    - Only creates records if they don't exist
    - Automatically accepts terms for OAuth users
*/
...
DO $$
BEGIN
  RAISE LOG 'OAuth trigger recreated successfully';
END $$;
